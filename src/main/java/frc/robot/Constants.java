...
public final class Constants {
    ...
    public static final class Arm {
        ...
        public static final double lowerArmRatio = (16.0 / 1.0);
        ...
        static { //Gamepiece 1 is Cone, Gamepiece 2 is Cube
            ...
            ArmMap.put(new Node(4, 1), new ArmSetpoint(2.68, 0.7));
        ...
        public static final ArmSetpoint STOW = new ArmSetpoint(0.62, 0.01); 
        public static final ArmSetpoint NOGAMESTOW = new ArmSetpoint(0.07, 0.01);
    ...
    public static final class Swerve {
        ...
        public static final Gains GAINS_ANGLE_SNAP = new Gains(0.017, 0.0, 0.0, 0.0, 50);
    
        public static final Gains GAINS_BALANCE = new Gains(0.045, 0.0, 0.0, 0.0, 50);
    
        public static final double SNAP_TOLLERANCE = 0.5;
