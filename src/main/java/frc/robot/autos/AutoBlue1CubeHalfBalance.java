...
public class AutoBlue1CubeHalfBalance extends SequentialCommandGroup {
    public AutoBlue1CubeHalfBalance(CommandSwerveDrivetrain s_Swerve, Arm a_Arm, Intake i_Intake, CubeKicker lilKick){
            ...
            addCommands(
                new ParallelCommandGroup(
                    new SequentialCommandGroup(
                        ...
                        new RepeatCommand(new InstantCommand(() -> s_Swerve.AutoBalance(0)))                             
                    ))
