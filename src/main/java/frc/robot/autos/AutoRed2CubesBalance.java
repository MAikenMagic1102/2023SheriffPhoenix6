...
public class AutoRed2CubesBalance extends SequentialCommandGroup {
    public AutoRed2CubesBalance(CommandSwerveDrivetrain s_Swerve, Arm a_Arm, Intake i_Intake, CubeKicker lilKick){
            ...
            addCommands(
                new ParallelCommandGroup(
                    new SequentialCommandGroup(
                        ...
                        new RepeatCommand(new InstantCommand(() -> s_Swerve.AutoBalance(180)))                        
                    ))
