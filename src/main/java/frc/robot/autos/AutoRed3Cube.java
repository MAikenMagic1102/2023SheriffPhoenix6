...
public class AutoRed3Cube extends SequentialCommandGroup {
    public AutoRed3Cube(CommandSwerveDrivetrain s_Swerve, Arm a_Arm, Intake i_Intake, CubeKicker lilKick){
        PathPlannerTrajectory test = PathPlanner.loadPath("1102TestRed", 5.0, 2.5);
            ...
            addCommands(
                new ParallelCommandGroup(
                    new SequentialCommandGroup(
                        ...
                        s_Swerve.followTrajectoryCommand(test, true).alongWith(new ArmToSetpoint(a_Arm, Constants.Arm.FLOORLOAD).alongWith(new InstantCommand(() -> lilKick.home()).alongWith(new IntakeIn(i_Intake)))),
                        ...
                        s_Swerve.followTrajectoryCommand(test4, false).alongWith(new IntakeIn(i_Intake).alongWith(new ArmToSetpoint(a_Arm, Constants.Arm.STOW))),
