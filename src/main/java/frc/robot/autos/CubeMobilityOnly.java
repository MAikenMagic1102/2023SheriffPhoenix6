...
public class CubeMobilityOnly extends SequentialCommandGroup {
    public CubeMobilityOnly (CommandSwerveDrivetrain s_Swerve, Arm a_Arm, Intake i_Intake, CubeKicker lilKick){
        PathPlannerTrajectory test = PathPlanner.loadPath("1102MobilityOnly", 2.0, 1.5);
