...
public class RedBump2 extends SequentialCommandGroup {
    public RedBump2(CommandSwerveDrivetrain s_Swerve, Arm a_Arm, Intake i_Intake, CubeKicker lilKick){
        PathPlannerTrajectory test = PathPlanner.loadPath("1102TestRedBump", 5.0, 3.0);
