...
public class Arm extends SubsystemBase {
  ...
  public Arm() {
    ...
    lowerConfig.Slot0.kP = 700; // An error of 1 rotation = 200 amps
    lowerConfig.Slot0.kI = 0; //
    lowerConfig.Slot0.kD = 80; // A change of 1 rotation per second results in 40 amps output

    // Peak output of 250 amps
    lowerConfig.TorqueCurrent.PeakForwardTorqueCurrent = 700;
    lowerConfig.TorqueCurrent.PeakReverseTorqueCurrent = -700;
  ...
  public void setLowerArmSetPoint(double setPoint){
    isClosedLoop = true;
      ...
      PositionTorqueCurrentFOC m_torquePosition = new PositionTorqueCurrentFOC(setPoint);
