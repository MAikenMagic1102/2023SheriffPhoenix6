...
public class Swerve extends SubsystemBase {
    ...
    public void drive(Translation2d translation, double rotation, boolean fieldRelative, boolean isOpenLoop) {
        ...
        public void setOdomToVisionPose(){
        ...
        public void AutoBalance(){
            ...
            double rotationVal = m_thetaController.calculate((MathUtil.inputModulus(this.getPose().getRotation().getDegrees(), -180, 180)), m_thetaController.getSetpoint());
            ...
            drive(new Translation2d(-pidOutput, 0), rotationVal, false, true);
        }
        ...
        public SequentialCommandGroup followTrajectoryCommand(PathPlannerTrajectory path1, boolean isFirstPath) {
         ...
         public SequentialCommandGroup followTrajectoryVisionCommand(PathPlannerTrajectory path1, boolean isFirstPath) {
