...
public class Intake extends SubsystemBase {
    ...
    if(keepHold){
        if(!leftLimit.isPressed() && GamePiece.getGamePiece() == GamePieceType.Cube){
          ...
          if(GamePiece.getGamePiece() == GamePieceType.Cone){
            ...
            PIDIntake1.setReference(0.5, ControlType.kDutyCycle);
            PIDIntake2.setReference(0.5, ControlType.kDutyCycle);
          }
  ...
  public void intakeShoot(){
    PIDIntake1.setReference(-1, ControlType.kDutyCycle);
    PIDIntake2.setReference(-1, ControlType.kDutyCycle);
    hRollerIntake.set(-0.8);
    keepHold = false;
  }

  public void intakeStop(){
    PIDIntake1.setReference(0.00, ControlType.kDutyCycle);
    PIDIntake2.setReference(0.00, ControlType.kDutyCycle);
    hRollerIntake.set(0.0);
    keepHold = false;
  }
